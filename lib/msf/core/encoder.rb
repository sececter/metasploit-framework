...
class Encoder < Module
  ...
  autoload :Xor,                 'msf/core/encoder/xor'
  autoload :XorAdditiveFeedback, 'msf/core/encoder/xor_additive_feedback'
  autoload :Alphanum,            'msf/core/encoder/alphanum'
  autoload :NonAlpha,            'msf/core/encoder/nonalpha'
  autoload :NonUpper,            'msf/core/encoder/nonupper'
